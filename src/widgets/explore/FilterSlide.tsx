...
export const FilterSlide = ({
  ...
  return (
    <>
      ...
      >
        <div className="mx-auto max-w-screen-md rounded-t-3xl bg-white px-6 pb-8 pt-4">
          {/* 핸들 바 */}
          ...
          <button
            onClick={handleApply}
            className="w-full rounded-full bg-gray-800 py-4 text-lg font-medium text-white hover:bg-gray-900 transition-colors"
          >
            확인
          </button>
