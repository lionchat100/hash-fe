...
export const NotifyCard = (props: Props) => {
  ...
  return (
    <Link href={notification.href} className="flex w-full items-center gap-2.5 py-2.5">
      ...
      <div className="w-[calc(100vw - 60px)] flex grow-1 justify-between">
        <div>
          <div className="w-[calc(100vw - 154px)] text-base font-semibold text-stone-900">{notification.title}</div>
