...
- **코드 품질**: 기획이 갑작스래 변경되더라도 기능별로 분리된 코드는 결합도가 낮기때문에 기능의 추가와 제거에 유연하게 대처가 가능하고 계층별 역할 덕분에 높은 응집도를 이룰 수 있습니다.
- **인수 인계**: 프로젝트가 인수인계되더라도 디렉토리 계층단위로 분리된 기존 아키텍처가 변형되지않고 무결성을 유지하기 쉽습니다.
---
## 프론트엔드 기술스택
### Frontend Framework
- Next.js 15.4.5
